...
class Player():
    ...
    # def update_moving_status(self, source_field=None, destination_field=None):
    #     if self.is_touching():
    #         self.moving_status = ('touching', self._touch.name_long + ' ' + self._touch.field)
    #     else:
    #         type, name = self.moving_status
    #         self.moving_status = ('move', name + ' ' + source_field + '-' + destination_field)
